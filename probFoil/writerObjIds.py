...
if __name__ == '__main__':
    ...
    objects= [
            ...
            {'objectId': 'obj3', 'color':'red','category':'orange', 'ownership':'Farid', 'size':'big', 'restriction':'doNotEat'},
            {'objectId': 'obj4', 'color':'green','category':'banana', 'ownership':'lili', 'size':'small','restriction':'doNotTouch'},
            {'objectId': 'obj5', 'color':'red','category':'apple', 'ownership':'lili', 'size':'small','restriction':'doNotTouch'},
            {'objectId': 'obj6','color':'yellow','category':'banana', 'ownership':'lili', 'size':'small', 'restriction':'doNotTouch'}
            ]
    foilWriter(filesPath='', objects=objects, learnFact= ['ownership','farid'])
